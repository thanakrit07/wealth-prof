  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 flex max-h-[92dvh] flex-col rounded-t-2xl border-t bg-popover text-sm text-popover-foreground shadow-lg outline-none",
          className
        )}
        {...props}
      >
        <div className="mx-auto mt-2.5 h-1.5 w-10 shrink-0 rounded-full bg-muted" />
        <div className="flex flex-1 flex-col gap-4 overflow-y-auto pb-[env(safe-area-inset-bottom)]">
          {children}
        </div>
      </DrawerPrimitive.Content>
    </DrawerPortal>
